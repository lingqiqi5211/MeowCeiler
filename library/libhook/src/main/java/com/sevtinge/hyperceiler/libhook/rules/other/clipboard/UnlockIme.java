...
*/
package com.sevtinge.hyperceiler.libhook.rules.other.clipboard;
...
public class UnlockIme implements IHook {
    ...
    private void hookDeleteNotSupportIme(String className, ClassLoader classLoader) {
        ...
        try {
            hookAllMethods(EzxHelpUtils.findClassIfExists(className, classLoader), "deleteNotSupportIme", returnConstant(null));
        } catch (Throwable throwable) {
