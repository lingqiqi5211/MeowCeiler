 ...
 */
class CrashRecord {
    public static final String TAG = "CrashRecord";
    // public String label;
    public String pkg;
    public long time;
    public int count;
    ...
    public JSONObject toJSON() {
        ...
        try {
            ...
            XposedLog.e(TAG, "Failed to convert JSON!" + e);
        }
        return jsonObject;
    }
    ...
    public static String getPkg(JSONObject jsonObject) {
        try {
            ...
            XposedLog.e(TAG, "Failed to get package name!" + e);
        }
        return "null";
    }
    ...
    public static long getTime(JSONObject jsonObject) {
        try {
            ...
            XposedLog.e(TAG, "Failed to get timestamp!" + e);
        }
        return -1L;
    }
    ...
    public static int getCount(JSONObject jsonObject) {
        try {
            ...
            XposedLog.e(TAG, "Failed to get the number of times!" + e);
        }
        return -1;
    }
    ...
    public static JSONObject putParam(JSONObject jsonObject, long time, int count) {
        try {
            ...
            XposedLog.e(TAG, "Failed to update data!" + e);
        }
        return null;
    }
    ...
    public static ArrayList<JSONObject> toArray(String json) {
        try {
            ...
            XposedLog.e(TAG, "Failed to convert Array!" + e);
        }
